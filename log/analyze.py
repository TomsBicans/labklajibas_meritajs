...
def log_file_graph_loc(logfile: str, semantic_value: int):
...
def main(logfile: str):
    ...
    for semantic_value in unique_semantic_values:
        ...
        ax.set_title(
            f"Numeric Value by Timestamp for {number_to_field_name(semantic_value)}"
        )
        ...
        fig.savefig(
            log_file_graph_loc(logfile, semantic_value)
...
if __name__ == "__main__":
    ...
    parser.add_argument("logfile", help="The log file to be analyzed")
